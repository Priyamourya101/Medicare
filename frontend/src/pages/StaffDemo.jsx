    ...
    <Box sx={{ p: 3 }}>
      ...
      <Alert severity="info" sx={{ mb: 3 }}>
        <Typography variant="body1">
          This is a demonstration of the staff management system. The system includes:
        </Typography>
      </Alert>
        ...
        <CardContent>
          <List>
            <ListItem>
              ...
              <ListItemText 
                primary="Staff Registration Form" 
                secondary="Comprehensive form with validation for adding new staff members"
              />
            </ListItem>
            <ListItem>
              <ListItemIcon>
              ...
              <ListItemText 
                ...
                secondary="Create, Read, Update, and Delete staff records"
              />
            </ListItem>
            <ListItem>
              <ListItemIcon>
            ...
            <ListItem>
              ...
              <ListItemText 
                ...
                secondary="Only administrators can add, edit, and delete staff"
              />
            </ListItem>
            <ListItem>
              <ListItemIcon>
              ...
              <ListItemText 
                primary="Employee Details Table" 
                secondary="Display staff information in a organized table format"
              />
            </ListItem>
            <ListItem>
              <ListItemIcon>
        ...
        <CardContent>
          ...
          <List>
            ...
            <ListItem>
              ...
              <ListItemText 
                primary="Database" 
                secondary="Set up a database to store staff information"
              />
            </ListItem>
            <ListItem>
              <ListItemIcon>
              ...
              <ListItemText 
                primary="File Upload" 
                secondary="Add profile picture upload functionality"
              />
            </ListItem>
          </List>
        </CardContent>
